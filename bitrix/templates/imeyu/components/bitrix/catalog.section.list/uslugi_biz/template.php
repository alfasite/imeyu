...
<div class="page-content">
                ...
                <div class="service container">
	 			    <div class="row">
    	 			 	<div><h1>Для бизнеса</h1></div>
						<?foreach ($arResult['SECTIONS'] as &$arSection):?>
						<a href="<?=$arSection['SECTION_PAGE_URL']?>" class="catalog-box col-xs-12 col-sm-6 col-md-3">
							<div class="catalog-box-inner">
								<img src="<? echo $arSection['PICTURE']['SRC']; ?>" alt="" class="catalog-box-image" style="width: 109px; height: 108px; top: 28.641px; left: 49.6443px;">
 							</div>
							<h3 class="catalog-box-name">
	...
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'LIST':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				if ($arParams["COUNT_ELEMENTS"])
				{
					?> <span>(<? echo $arSection["ELEMENT_CNT"]; ?>)</span>Это?<?
				}
				?></a></h2><?
