...
$APPLICATION->SetPageProperty("title", "Иные споры");
$APPLICATION->SetPageProperty("description", "Иные споры");
...
?><div class="page-content">
	<div class="breadcrumbs container">
		<ul>
			<ul class="B_crumbBox">
				...
				<li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_crumb" itemprop="url" rel="✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» в Орле, Предоставляет юридические услуги для бизнеса ➡ Узнать подробнее ✔" href="/uslugi/dlya-biznesa.html"><span itemprop="title">Для бизнеса</span></a></li>
				<li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_crumb" itemprop="url" rel="Юридическая помощь в вопросах с госорганами и гражданами. Бесплатная консультация по телефону 8 (4862) 784-784. Звоните! В ЦПУ «Имею Право» Вам помогут решить все возникшие вопросы." href="/uslugi/dlya-biznesa/sporyi-s-gosorganami.html"><span itemprop="title">Cпоры с госорганами и гражданами</span></a></li>
				<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Иные споры" href="/uslugi/dlya-biznesa/sporyi-s-gosorganami/inyie-sporyi.html"><span itemprop="title">Иные споры</span></a></li>
			</ul>
		</ul>
	</div>
	 <!--breadcrumbs-->
 ...
 <img src="/bitrix/images/sp-s-gosorg.jpg" alt="">
				</div>
				 <!--service-image-->
				<div class="service-info col-xs-12 col-sm-7">
					...
					<div class="new-sp">
						<ul>
							<li>
							Вам нужно защитить интересы Вашей организации в споре с Пенсионным фондом? </li>
							<li>
							Вам нужно оспорить действия и решения Фонда социального страхования? </li>
							<li>
							Вам нужно защитить права организации в споре с таможенным органом? </li>
							<li>
							Вам нужно представление интересов в спорах с иными государственными органами? </li>
						</ul>
						 <!--service-list-->
					</div>
 <button class="btn btn-black" data-toggle="modal" data-target="#consultModal">ПРОКОНСУЛЬТИРОВАТЬСЯ</button>
	...
	<div class="service-text-block">
		<div class="container">
			...
			Иные споры, <span>важно знать! </span> </h2>
			<p>
				 В&nbsp;ЦПУ «Имею Право» Вы&nbsp;можете получить юридическую помощь квалифицированных специалистов по&nbsp;спорам с&nbsp;госорганами: консультирование, составление и&nbsp;анализ различного рода документов и&nbsp;исков, представление интересов в&nbsp;суде и&nbsp;иные возможные механизмы защиты и&nbsp;реализации Ваших прав.
			</p>
			<p>
 ...
 <span>Заполните форму,</span> и мы свяжемся с Вами
					...
					<form action="/uslugi/dlya-biznesa/sporyi-s-gosorganami/inyie-sporyi.html#form_consult" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
 ...
 <span>3</span>
	...
	<div class="container">
		<div class="practice-block">
			...
			<div class="row" style="position: relative; height: 924px;">
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 0px; top: 0px;">
					<div class="case-label">
						 Дело №04023
					</div>
					<h3 class="case-heading">Признание незаконным предписания о демонтаже рекламной конструкции</h3>
					<ul class="case-list">
						<li class="case-item case-problem">
						<h4 class="case-item-name">Проблема:</h4>
						<div class="case-item-text">
							<p>
								 Департамент госимущества Орловской области вынес предписание о демонтаже рекламных конструкций, которые ИП, разместивший их, считал информационными вывесками.&nbsp;
							</p>
						</div>
 </li>
						...
						<div class="case-item-text">
							<ul>
								...
								<li>Подготовка и направление отзыва на апелляционную жалобу</li>
								<li>Представление интересов в суде апелляционной инстанции — 19 ААС в г. Воронеж</li>
							</ul>
						</div>
 </li>
						...
						<div class="case-item-text">
							<p>
 <a href="/files/Решения/04023.pdf">Решение суда</a>
							</p>
						</div>
 </li>
						...
						<div class="case-item-text">
							<p>
								 Предписание, вынесенное Департаментом госимущества Орловской области, было признано недействительным как несоответствующее закону.
							</p>
						</div>
 </li>
					</ul>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 485px; top: 0px;">
					...
					<h3 class="case-heading">Обжалование ненормативного акта Пенсионного фонда</h3>
					<ul class="case-list">
						<li class="case-item case-problem">
						<h4 class="case-item-name">Проблема:</h4>
						<div class="case-item-text">
							<p>
								 Организация привлечена к административной ответственности (штрафу) за совершение нарушения законодательства РФ о страховых взносах на основании решения управления Пенсионного фонда об обнаружении фактов, свидетельствующих о нарушении законодательства РФ о страховых взносах
							</p>
						</div>
 </li>
						<li class="case-item case-work">
						...
						<div class="case-item-text">
							<ul>
								...
								<li>Разработка наиболее эффективного и быстрого варианта разрешения проблемы</li>
								<li>Составление заявления о признании недействительным решения управления Пенсионного фонда</li>
						...
						<div class="case-item-text">
							<p>
								 Судом признаны недействительными положения решения управления Пенсионного фонда
							</p>
						</div>
 </li>
					</ul>
				 ...
				 <!--case-box-->
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 748px;">
					<div class="case-label">
						 Дело №02079
					</div>
					<h3 class="case-heading">Отказ Пенсионного фонда учесть ранее уплаченные выплаты при реорганизации фирмы</h3>
					<ul class="case-list">
						<li class="case-item case-problem">
						<h4 class="case-item-name">Проблема:</h4>
						<div class="case-item-text">
							<p>
								 После реорганизации фирмы Клиента Пенсионный фонд отказался учитывать уплаченные ранее выплаты по сотрудникам организации для расчета базы для начисления страховых взносов
							</p>
						</div>
 </li>
						<li class="case-item case-work">
						...
						<div class="case-item-text">
							<p>
								 Суд обязал управление Пенсионного фонда учесть выплаты по сотрудникам организации Клиента для расчета базы для начисления страховых взносов, а также взысканы судебные расходы, понесенные Клиентом
							</p>
						</div>
 </li>
					</ul>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 748px;">
					...
					<h3 class="case-heading">Защита по ст. 16.2 КоАП за недекларирование товара</h3>
					<ul class="case-list">
						<li class="case-item case-problem">
						<h4 class="case-item-name">Проблема:</h4>
						<div class="case-item-text">
							<p>
								 Привлечение организации к ответственности за недекларирование товара
							</p>
						</div>
 </li>
						<li class="case-item case-work">
						...
						<div class="case-item-text">
							<ul>
								...
								<li>Подготовка и направление жалобы должностному лицу</li>
								<li>Подготовка и направление жалобы в суд</li>
								<li>Представление интересов в суде</li>
							</ul>
						</div>
 </li>
						...
						<div class="case-item-text">
							<p>
								 Деяние было признано малозначительным, штраф снят
							</p>
						</div>
 </li>
					</ul>
