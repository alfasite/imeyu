...
$APPLICATION->SetPageProperty("title", "Иные вопросы по трудовому праву для организаций");
$APPLICATION->SetPageProperty("description", "✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» Оказывает юридические услуги и правовую помощь в Орле по различным вопросам трудового права для организаций, проводит юридические консультации и услуги представителя в суде ➡ Узнать подробнее ✔");
...
?><div class="page-content">
	<div class="breadcrumbs container">
		<ul>
			<ul class="B_crumbBox">
				...
				<li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_crumb" itemprop="url" rel="✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» предоставляет услуги защиты интересов в области трудового права, согласно трудовому законодательству РФ ➡ Узнать подробнее ✔" href="/uslugi/dlya-biznesa/trudovoe-pravo.html"><span itemprop="title">Трудовое право</span></a></li>
				<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» Оказывает юридические услуги и правовую помощь в Орле по различным вопросам трудового права для организаций, проводит юридические консультации и услуги представителя в суде ➡ Узнать подробнее ✔" href="/uslugi/dlya-biznesa/trudovoe-pravo/inyie-voprosyi.html"><span itemprop="title">Иные вопросы</span></a></li>
			</ul>
		</ul>
	</div>
	 <!--breadcrumbs-->
	<div class="service container">
		<div class="row">
			<div>
				<h1>Иные вопросы по трудовому праву</h1>
			</div>
			<div class="service-item">
				<div class="service-image col-xs-12 col-sm-5">
 <img src="/bitrix/images/in-sp-tr-pravo.jpg" alt="">
				</div>
				 <!--service-image-->
				<div class="service-info col-xs-12 col-sm-7">
					...
					<div class="new-sp">
						<ul>
							<li>Вам нужно сократить численность штата?</li>
							<li>Вам нужно ликвидировать организацию?</li>
							<li>Вам нужно представление интересов в контролирующих органах?</li>
							<li>Вам нужно провести аудит документации по трудовым отношениям в организации?</li>
						</ul>
						 <!--service-list-->
					</div>
 <button class="btn btn-black" data-toggle="modal" data-target="#consultModal">ПРОКОНСУЛЬТИРОВАТЬСЯ</button>
	...
	<div class="service-text-block">
		<div class="container">
			...
			<p>
				 В&nbsp;ЦПУ «Имею Право» Вы&nbsp;можете получить юридическую помощь квалифицированных специалистов по&nbsp;вопросам трудового права: консультирование, составление и&nbsp;анализ различного рода документов и&nbsp;исков, представление интересов в&nbsp;суде и&nbsp;иные возможные механизмы защиты и&nbsp;реализации Ваших прав.
			</p>
			<p>
 ...
 <span>Заполните форму,</span> и мы свяжемся с Вами
					...
					<form action="/uslugi/dlya-biznesa/trudovoe-pravo/inyie-voprosyi.html#form_consult" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
 ...
 <span>3</span>
	...
	<div class="container">
		<div class="practice-block">
			...
			<div class="row" style="position: relative; height: 608px;">
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 0px; top: 0px;">
					<div class="case-label">
						 Дело №02023
					</div>
					<h3 class="case-heading">Разъяснения работнику по размерам выходного пособия</h3>
					<ul class="case-list">
						<li class="case-item case-problem">
						<h4 class="case-item-name">Проблема:</h4>
						<div class="case-item-text">
							<p>
								 Работник обратился к работодателю с требованием доплатить задолженность по заработной плате и компенсацию неиспользованного отпуска, выплаченных при увольнении
							</p>
						</div>
 </li>
						...
						<div class="case-item-text">
							<ul>
								<li>Расчет всех причитающихся работнику сумм</li>
								<li>Составление и направление письменных пояснений работнику</li>
							</ul>
						</div>
 </li>
						...
						<div class="case-item-text">
							<p>
								 Работник отказался от предъявленных тредований
							</p>
						</div>
 </li>
					</ul>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 485px; top: 0px;">
					...
					<h3 class="case-heading">Сокращение штата работников</h3>
					<ul class="case-list">
						<li class="case-item case-problem">
						<h4 class="case-item-name">Проблема:</h4>
						<div class="case-item-text">
							<p>
								 Необходимо законно провести процедуру сокращения штата работников
							</p>
						</div>
 </li>
						<li class="case-item case-work">
						...
						<div class="case-item-text">
							<ul>
								...
								<li>Разработка письменных рекомендаций по процедуре</li>
							</ul>
						</div>
 </li>
						<li class="case-item case-result">
						...
						<div class="case-item-text">
							<p>
								 Штат был сокращен в соответствии с действующим законодательством
							</p>
						</div>
 </li>
					</ul>
				 ...
				 <!--case-box-->
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 547px;">
					<div class="case-label">
						 Дело №01019
					</div>
					<h3 class="case-heading">Аудит кадровых документов</h3>
					<ul class="case-list">
						<li class="case-item case-problem">
						<h4 class="case-item-name">Проблема:</h4>
						<div class="case-item-text">
							<p>
								 Перед государственной проверкой организация заказала аудит кадровой документации
							</p>
						</div>
 </li>
						<li class="case-item case-work">
						...
						<div class="case-item-text">
							<ul>
								<li>Проверка локальных нормативных актов организации</li>
								<li>Проверка трудовых договоров с работниками</li>
								<li>Проверка приказов</li>
								<li>Проверка штатного расписания</li>
								<li>Аудит трудовых книжек</li>
								<li>Проверка иной документации</li>
								<li>Оформление результатов аудита</li>
							</ul>
						</div>
 </li>
						<li class="case-item case-result">
						...
						<div class="case-item-text">
							<p>
								 Найдены нарушения трудового законодательства в части регулирования оплаты труда, разработаны рекомендации и варианты устранения нарушений
							</p>
						</div>
 </li>
					</ul>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 547px;">
					...
					<h3 class="case-heading">Обоснование законности перевода в государственной инспекции труда</h3>
					<ul class="case-list">
						<li class="case-item case-problem">
						<h4 class="case-item-name">Проблема:</h4>
						<div class="case-item-text">
							<p>
								 Работником подана жалоба в гос. инспекцию труда о незаконности перевода без согласия работника в другое подразделение
							</p>
						</div>
 </li>
						<li class="case-item case-work">
						...
						<div class="case-item-text">
							<ul>
								<li>Составление правового заключения о правомерности проведенной процедуры</li>
								<li>Направление письменных пояснений в трудовую инспекцию</li>
							</ul>
						</div>
 </li>
						<li class="case-item case-result">
						...
						<div class="case-item-text">
							<p>
								 Перевод в другое структурное подразделение без изменения определенных договором условий договора признан законным
							</p>
						</div>
 </li>
					</ul>
