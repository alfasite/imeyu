...
$APPLICATION->SetPageProperty("description", "Юридическая помощь по разрешению кредитных споров. Бесплатная консультация по телефону 8 (4862) 784-784. Звоните! В ЦПУ «Имею Право» Вам помогут решить все возникшие вопросы.");
$APPLICATION->SetPageProperty("title", "Решение кредитных споров с банками, успешная судебная практика по кредитным спорам в ЦПУ «Имею Право»");
...
?><div class="page-content">
	<div class="breadcrumbs container">
		<ul>
			<ul class="B_crumbBox">
				...
				<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Юридическая помощь по разрешению кредитных споров. Бесплатная консультация по телефону 8 (4862) 784-784. Звоните! В ЦПУ «Имею Право» Вам помогут решить все возникшие вопросы." href="/uslugi/dlya-grazhdan/sporyi-s-bankami.html"><span itemprop="title">Разрешение кредитных споров</span></a></li>
			</ul>
		</ul>
	</div>
	 <!--breadcrumbs-->
	<div class="catalog-block container">
		<div>
			<h1>Разрешение кредитных споров</h1>
		</div>
		<div class="row">
 <a href="/uslugi/dlya-grazhdan/sporyi-s-bankami/osparivanie-i-snizhenie-shtrafov-i-neustoek.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/osp-i-snizh-shtrafov.jpg" alt="" class="catalog-box-image" style="width: 105px; height: 104px; top: 30px; left: 52px;">
			</div>
			<h3 class="catalog-box-name"><span>Юрист по кредитам и долгам</span></h3>
 </a> <!--catalog-box--> <a href="/uslugi/dlya-grazhdan/sporyi-s-bankami/zashhita-poruchitelej-po-kreditu.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/zashita-poruch-po-kredity.jpg" alt="" class="catalog-box-image" style="width: 105px; height: 104px; top: 30px; left: 52px;">
			</div>
			<h3 class="catalog-box-name"><span>Защита поручителей по кредиту</span></h3>
 </a> <!--catalog-box--> <a href="/uslugi/dlya-grazhdan/sporyi-s-bankami/nezakonnyie-komissii-i-straxovanie.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/nezakon-kkomis-i-strah.jpg" alt="" class="catalog-box-image">
			</div>
			<h3 class="catalog-box-name"><span>Незаконные комиссии и страхование</span></h3>
 </a> <!--catalog-box--> <a href="/uslugi/dlya-grazhdan/sporyi-s-bankami/inyie-voprosyi.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/in-sp-semeinoebank.jpg" alt="" class="catalog-box-image">
			</div>
 ...
 <span>Заполните форму</span>, и мы свяжемся с Вами
					...
					<form action="/uslugi/dlya-grazhdan/sporyi-s-bankami.html#form_lawyer" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
 ...
 <input class="btn btn-red" type="submit" name="btn_lawyer" value="ПОЛУЧИТЬ КОНСУЛЬТАЦИЮ">
	...
	<div class="catalog-block container">
		<p>
			 В ЦПУ «Имею Право» Вы можете получить юридическую помощь квалифицированных специалистов по разрешению споров с кредитными организациями: консультирование, составление и анализ различного рода документов и исков, представление интересов в суде и иные возможные механизмы защиты и реализации Ваших прав.
		</p>
		<p>
