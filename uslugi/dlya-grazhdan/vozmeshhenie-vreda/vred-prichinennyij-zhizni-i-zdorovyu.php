...
$APPLICATION->SetPageProperty("title", "Вред, причиненный жизни и здоровью");
$APPLICATION->SetPageProperty("description", "Вред, причиненный жизни и здоровью");
...
?><div class="page-content">
	<div class="breadcrumbs container">
		<ul>
			<ul class="B_crumbBox">
				...
				<li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_crumb" itemprop="url" rel="✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» в Орле, поможет по вопросам возмещения материального и морального вреда, вреда, причиненного жизни и здоровью ➡ Узнать подробнее ✔" href="/uslugi/dlya-grazhdan/vozmeshhenie-vreda.html"><span itemprop="title">Возмещение вреда</span></a></li>
				<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Вред, причиненный жизни и здоровью" href="/uslugi/dlya-grazhdan/vozmeshhenie-vreda/vred-prichinennyij-zhizni-i-zdorovyu.html"><span itemprop="title">Вред, причиненный жизни и здоровью</span></a></li>
			</ul>
		</ul>
	</div>
	 <!--breadcrumbs-->
	<div class="service container">
		<div class="row">
			<div>
				<h1>Вред, причиненный жизни и здоровью</h1>
			</div>
			<div class="service-item">
				<div class="service-image col-xs-12 col-sm-5">
 <img src="/bitrix/images/vozmestit-me-2.jpg" alt="">
				</div>
				 <!--service-image-->
				<div class="service-info col-xs-12 col-sm-7">
					...
					<div class="new-sp">
						<ul>
							<li>
							Вам нужно взыскать расходы на лечение с причинителя вреда? </li>
							<li>
							Вам нужно возместить вред здоровью, причиненный на производстве? </li>
							<li>
							Вам нужно возместить расходы на лечение, понесенные вследствие ДТП? </li>
							<li>
							Вам нужно взыскать денежную компенсацию морального вреда? </li>
							<li>
							Вам нужно уменьшить размер взыскиваемых с Вас сумм? </li>
						</ul>
						 <!--service-list-->
					</div>
 <button class="btn btn-black" data-toggle="modal" data-target="#consultModal">ПРОКОНСУЛЬТИРОВАТЬСЯ</button>
	...
	<div class="service-text-block">
		<div class="container">
			...
			Вред, причиненный жизни и здоровью, <span>важно знать! </span> </h2>
			<p>
				Компенсировать само здоровье, к&nbsp;сожалению, невозможно, однако виновный в&nbsp;причинении вреда (и&nbsp;в&nbsp;ряде случаев&nbsp;— страховая компания) в&nbsp;соответствии с&nbsp;законом обязаны возместить понесенные расходы на&nbsp;лечение, покупку необходимых препаратов и&nbsp;прохождение процедур, компенсировать утраченный заработок, возместить причиненный моральный вред, компенсировать иные возможные убытки.
			</p>
			<p>
				Привлечь к&nbsp;материальной ответственности виновника, собрать необходимую для суда доказательную базу в&nbsp;целях полной реализации Вашего права на&nbsp;возмещение причиненного вреда здоровью в&nbsp;соответствии с&nbsp;требованиями закона и&nbsp;сложившейся судебной практики помогут в&nbsp;ЦПУ «Имею Право».
			</p>
		</div>
		 <!--container-->
	</div>
		...
		<div class="container">
			...
			<div class="consult-box row">
				...
				<div class="consult-form col-xs-12 col-md-6">
					...
					<form action="/uslugi/dlya-grazhdan/vozmeshhenie-vreda/vred-prichinennyij-zhizni-i-zdorovyu.html#form_consult" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
 ...
 <button type="button" class="btn btn-white" data-toggle="modal" data-target="#consultModal">
	...
	<div class="container">
		<div class="practice-block">
			...
			<div class="row" style="position: relative; height: 625px;">
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 0px; top: 0px;">
					...
					<ul class="case-list">
						...
						<div class="case-item-text">
							Требования удовлетворены, компенсирован вред здоровью, моральный и имущественный вред, расходы на лечение, судебные расходы в общем размере 183 516,50 руб.
						</div>
 </li>
					</ul>
				</div>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 485px; top: 0px;">
					...
					<ul class="case-list">
						...
						<p class="case-item-hidden">
							Возмещение вреда здоровью, расходов на лечение, компенсации морального вреда потерпевшему от ДТП.
						</p>
 <a href="#" class="case-item-more">Подробнее</a> </li>
						...
						<h4 class="case-item-name">Результат:</h4>
						<div class="case-item-text">
							Требования удовлетворены, компенсирован легкий вред здоровью, моральный вред и судебные расходы в общем размере 73 000 руб.
						</div>
 </li>
					</ul>
				</div>
				 <!--case-box-->
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 611px;">
					<div class="case-label">
						Дело №03063
					</div>
					...
					<ul class="case-list">
						...
						<h4 class="case-item-name">Результат:</h4>
						<div class="case-item-text">
							Моральный вред взыскан в размере 20 000 рублей
						</div>
 </li>
					</ul>
				</div>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 611px;">
					...
					<ul class="case-list">
						...
						<h4 class="case-item-name">Результат:</h4>
						<div class="case-item-text">
							Компенсирован вред здоровью, моральный вред, расходы на покупку лекарств, судебные расходы в общем размере 101 000 руб.
						</div>
 </li>
					</ul>
				</div>
