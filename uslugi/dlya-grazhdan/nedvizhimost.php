...
$APPLICATION->SetPageProperty("title", "Недвижимость — Сопровождение сделок — Оформление недвижимости");
$APPLICATION->SetPageProperty("description", "✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» в Орле окажет юридическую помощь специалистов по оформлению недвижимости, спорами с застройщиками  ➡ Узнать подробнее ✔");
...
?><div class="page-content">
	<div class="breadcrumbs container">
		<ul>
			<ul class="B_crumbBox">
				...
				<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» в Орле окажет юридическую помощь специалистов по оформлению недвижимости, спорами с застройщиками ➡ Узнать подробнее ✔" href="/uslugi/dlya-grazhdan/nedvizhimost.html"><span itemprop="title">Недвижимость</span></a></li>
			</ul>
		</ul>
	</div>
	 <!--breadcrumbs-->
	<div class="catalog-block container">
		...
		<div class="row">
 <a href="/uslugi/dlya-grazhdan/nedvizhimost/oformlenie-nedvizhimosti.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/oformlenie-nedv.jpg" alt="" class="catalog-box-image" style="width: 105px; height: 104px; top: 30px; left: 52px;">
			</div>
			<h3 class="catalog-box-name"><span>Услуги по оформлению недвижимости</span></h3>
 </a> <!--catalog-box--> <a href="/uslugi/dlya-grazhdan/nedvizhimost/zashhita-prav-sobstvennika-v-sude.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/arbitrazh.jpg" alt="" class="catalog-box-image">
			</div>
			<h3 class="catalog-box-name"><span>Защита прав собственника в суде</span></h3>
 </a> <!--catalog-box--> <a href="/uslugi/dlya-grazhdan/nedvizhimost/privatizacziya.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/privatizaciya.jpg" alt="" class="catalog-box-image">
			</div>
			<h3 class="catalog-box-name"><span>Помощь в приватизации</span></h3>
 </a> <!--catalog-box--> <a href="/uslugi/dlya-grazhdan/zhilishhnyie-sporyi/sporyi-s-zastrojshhikami.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/spori-s-zastroishikami.jpg" alt="" class="catalog-box-image">
			</div>
			<h3 class="catalog-box-name"><span>Споры с застройщиками</span></h3>
 </a> <!--catalog-box--> <a href="/uslugi/dlya-grazhdan/nedvizhimost/inyie-voprosyi.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/in-sp-semeinoe-zemlya-i-ned.jpg" alt="" class="catalog-box-image">
			</div>
 ...
 <span>Заполните форму</span>, и мы свяжемся с Вами
					...
					<form action="/uslugi/dlya-grazhdan/nedvizhimost.html#form_lawyer" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
 ...
 <input class="btn btn-red" type="submit" name="btn_lawyer" value="ПОЛУЧИТЬ КОНСУЛЬТАЦИЮ">
	...
	<div class="catalog-block container">
		<p>
			 В&nbsp;ЦПУ «Имею Право» Вы&nbsp;можете получить юридическую помощь квалифицированных специалистов по&nbsp;оформлению недвижимости, спорам с&nbsp;застройщиками: консультирование, составление и&nbsp;анализ различного рода документов и&nbsp;исков, представление интересов в&nbsp;суде и&nbsp;иные возможные механизмы защиты и&nbsp;реализации Ваших прав.
		</p>
		<p>
