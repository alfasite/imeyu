...
?><div class="page-content">
 ...
 <img src="/bitrix/images/vz-element.jpg" alt="" class="catalog-box-image" style="width: 164px; height: 164px; top: 13.12px; left: 22.7413px;">
			</div>
		...
		<div class="container">
			...
			<div class="consult-box row">
				...
				<div class="consult-form col-xs-12 col-md-6">
					...
					<form action="/uslugi/dlya-grazhdan/semejnoe-pravo.html#form_lawyer" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
