...
$APPLICATION->SetPageProperty("title", "Иные вопросы по спорам с банками");
$APPLICATION->SetPageProperty("description", "✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» Оказывает юридические услуги и правовую помощь в Орле по различным вопросам споров с банками граждан, проводит юридические консультации и услуги представителя в суде ➡ Узнать подробнее ✔");
...
?><div class="page-content">
	<div class="breadcrumbs container">
		<ul>
			<ul class="B_crumbBox">
				...
				<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» Оказывает юридические услуги и правовую помощь в Орле по различным вопросам споров с банками граждан, проводит юридические консультации и услуги представителя в суде ➡ Узнать подробнее ✔" href="/uslugi/dlya-grazhdan/sporyi-s-bankami/inyie-voprosyi.html"><span itemprop="title">Иные вопросы</span></a></li>
			</ul>
		</ul>
	</div>
	 <!--breadcrumbs-->
 ...
 <img src="/bitrix/images/in-sp-semeinoebank.jpg" alt="">
				</div>
				 <!--service-image-->
				<div class="service-info col-xs-12 col-sm-7">
					...
					<div class="new-sp">
						<ul>
							<li>Вам нужно признать себя банкротом?</li>
							<li>Вам нужно защитить себя от незаконных действий коллекторов?</li>
							<li>Вам нужно реализовать свои права как заемщика по ипотеке?</li>
							<li>Вам нужно признать условия договора с микрофинансовой организацией незаконными?</li>
							<li>Вам нужно разработать законный план погашения задолженности?</li>
 ...
 <button class="btn btn-black" data-toggle="modal" data-target="#consultModal">ПРОКОНСУЛЬТИРОВАТЬСЯ</button>
	...
	<div class="service-text-block">
		<div class="container">
			...
			<p>
				В&nbsp;ЦПУ «Имею Право» Вы&nbsp;можете получить юридическую помощь квалифицированных специалистов по&nbsp;спорам с&nbsp;кредитными организациями: консультирование, составление и&nbsp;анализ различного рода документов и&nbsp;исков, представление интересов в&nbsp;суде и&nbsp;иные возможные механизмы защиты и&nbsp;реализации Ваших прав.
			</p>
			<p>
		...
		<div class="container">
			...
			<div class="consult-box row">
				...
				<div class="consult-form col-xs-12 col-md-6">
					...
					<form action="/uslugi/dlya-grazhdan/sporyi-s-bankami/inyie-voprosyi.html#form_consult" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
 ...
 <button type="button" class="btn btn-white" data-toggle="modal" data-target="#consultModal">
	...
	<div class="container">
		<div class="practice-block">
			...
			<div class="row" style="position: relative; height: 575px;">
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 0px; top: 0px;">
					...
					<ul class="case-list">
						...
						<div class="case-item-text">
							Погашение неустойки прежде суммы основного долга признано незаконным, взыскана компенсация морального вреда
						</div>
 </li>
					</ul>
				</div>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 485px; top: 0px;">
					...
					<ul class="case-list">
						...
						<h4 class="case-item-name">Результат:</h4>
						<div class="case-item-text">
							Удовлетворено требование о защите персональных данных, а также взыскании морального вреда и судебных расходов.
						</div>
 </li>
					</ul>
				</div>
				 <!--case-box-->
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 0px; top: 567px;">
					<div class="case-label">
						Дело №02903
					</div>
					...
					<ul class="case-list">
						...
						<p class="case-item-hidden">
							Право требования по данному договору было передано банком коллекторам.
						</p>
 <a href="#" class="case-item-more">Подробнее</a> </li>
						...
						<h4 class="case-item-name">Результат:</h4>
						<div class="case-item-text">
							В удовлетворении требований коллекторов было отказано в полном объеме в связи с пропуском исковой давности
						</div>
 </li>
					</ul>
				</div>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 0px; top: 567px;">
					...
					<ul class="case-list">
						...
						<h4 class="case-item-name">Результат:</h4>
						<div class="case-item-text">
							Прекращение незаконных действий коллекторов в добровольном порядке
						</div>
 </li>
					</ul>
				</div>
