...
$APPLICATION->SetPageProperty("title", "Иные услуги для граждан");
$APPLICATION->SetPageProperty("description", "иные услуги для граждан,иных услуг для граждан,иным услугам для граждан,иные услуги для граждан,иными услугами для граждан,иные услуги для граждан");
...
?><div class="page-content">
	<div class="breadcrumbs container">
		<ul>
			<ul class="B_crumbBox">
				...
				<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="иные услуги для граждан,иных услуг для граждан,иным услугам для граждан,иные услуги для граждан,иными услугами для граждан,иные услуги для граждан" href="/uslugi/dlya-grazhdan/inyie-uslugi.html"><span itemprop="title">Иные услуги для граждан</span></a></li>
			</ul>
		</ul>
	</div>
	 <!--breadcrumbs-->
	<div class="service container">
		<div class="row">
			<div>
				<h1>Иные услуги для граждан</h1>
			</div>
			<div class="service-item">
				<div class="service-image col-xs-12 col-sm-5">
 <img src="/bitrix/images/inie-uslugi.jpg" alt="">
				</div>
				 <!--service-image-->
				<div class="service-info col-xs-12 col-sm-7">
					...
					<div class="new-sp">
						<ul>
							<li>Вам нужно получить юридическую консультацию?</li>
							<li>Вам нужно грамотное представление Ваших интересов в&nbsp;суде?</li>
							<li>Вам нужно составить или провести юридический анализ документов?</li>
							<li>Вам нужно оформить сделку?</li>
							<li>Вам нужно защитить свои права по&nbsp;административным спорам?</li>
							<li>Вам нужно реализовать свое право на&nbsp;наследство?</li>
							<li>Вам нужно защитить себя в&nbsp;судебном споре?</li>
							<li>Вам нужна юридическая помощь на&nbsp;стадии исполнительного производства?</li>
							<li>Вам нужно установить факт, имеющий юридическое значение?</li>
						</ul>
					</div>
 <button class="btn btn-black" data-toggle="modal" data-target="#consultModal">ПРОКОНСУЛЬТИРОВАТЬСЯ</button>
	...
	<div class="service-text-block">
		<div class="container">
			...
			Иные услуги для граждан, <span>важно знать! </span> </h2>
			<p>
				 В&nbsp;ЦПУ «Имею Право» Вы&nbsp;можете получить юридическую помощь квалифицированных специалистов: консультирование, составление и&nbsp;анализ различного рода документов и&nbsp;исков, представление интересов в&nbsp;суде и&nbsp;иные возможные механизмы защиты и&nbsp;реализации Ваших прав.
			</p>
			<p>
 ...
 <span>Заполните форму,</span> и мы свяжемся с Вами
					...
					<form action="/uslugi/dlya-grazhdan/inyie-uslugi.html#form_consult" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
 ...
 <span>3</span>
	...
	<div class="container">
		<div class="practice-block">
			...
			<div class="row" style="position: relative; height: 874px;">
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 0px; top: 0px;">
					...
					<ul class="case-list">
						...
						<div class="case-item-text">
							<p>
								 В отношении Клиента было возбуждено дело об административном правонарушении (ст. 5.61 КоАП РФ)
							</p>
						</div>
 </li>
						...
						<div class="case-item-text">
							<p>
 <a href="/files/Решения/5039.pdf">Решение суда</a>
							</p>
						</div>
 </li>
						...
						<div class="case-item-text">
							<p>
								 Производство по делу было прекращено ввиду отсутствия в действиях Клиента состава административного правонарушения. Постановление мирового судьи было оставлено без изменения
							</p>
						</div>
 </li>
					</ul>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 485px; top: 0px;">
					...
					<ul class="case-list">
						...
						<div class="case-item-text">
							<p>
								 Титульный собственник просил суд истребовать машину из чужого незаконного владения Клиента
							</p>
						</div>
 </li>
						<li class="case-item case-work">
						...
						<div class="case-item-text">
							<p>
 <a href="/files/Решения/04051.pdf">Решение суда</a>
							</p>
						</div>
 </li>
						<li class="case-item case-result">
						...
						<div class="case-item-text">
							<p>
								 Как в суде первой инстанции, так и в Орловском областном суде была подтверждена правильность правовой позиции Клиента, в удовлетворении иска было отказано
							</p>
						</div>
 </li>
					</ul>
				 ...
				 <!--case-box-->
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 0px; top: 845px;">
					<div class="case-label">
						 Дело №02053
					</div>
					...
					<ul class="case-list">
						...
						<div class="case-item-text">
							<p>
								 По решению суда в пользу Клиента с другого физлица была взыскана денежная сумма. В рамках уголовного дела был вынесен приговор, которым установлено, что Ответчик является потерпевшим по делу, на основании чего он подал заявление о пересмотре гражданского дела
							</p>
						</div>
 </li>
						<li class="case-item case-work">
						...
						<div class="case-item-text">
							<p>
 <a href="/files/Решения/02053-2 (1).pdf">Решение</a>
							</p>
						</div>
 </li>
						<li class="case-item case-result">
						...
						<div class="case-item-text">
							<p>
								 Орловским областным судом определение суда первой инстанции в интересах Клиента было отменено, в удовлетворении заявления о пересмотре дела отказано
							</p>
						</div>
 </li>
					</ul>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 0px; top: 845px;">
					...
					<ul class="case-list">
						...
						<p class="case-item-hidden">
							 Указанный вклад был открыт наследодателем во время нахождения в браке с обратившимся за помощью Клиентом. Установленные законодательством сроки для обращения к нотариусу к моменту обращения были пропущены
						</p>
 <a href="#" class="case-item-more">Подробнее</a> </li>
						...
						<h4 class="case-item-name">Результат:</h4>
						<div class="case-item-text">
							 Супружеская доля и часть наследства, причитающегося Клиенту по закону, была возвращена из незаконного владения другого наследника в добровольном порядке, без обращения в суд
						</div>
 </li>
					</ul>
				</div>
