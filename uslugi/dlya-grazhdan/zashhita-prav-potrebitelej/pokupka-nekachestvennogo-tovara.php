...
$APPLICATION->SetPageProperty("title", "Покупка некачественного товара");
$APPLICATION->SetPageProperty("description", "Покупка некачественного товара");
...
?><div class="page-content">
	<div class="breadcrumbs container">
		<ul>
			<ul class="B_crumbBox">
				...
				<li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_crumb" itemprop="url" rel="ЦПУ «Имею Право» предоставляет профессиональную юридическую помощь по защите прав потребителей в Орле. В нашей компании Вы получите бесплатную консультацию и гарантии нахождения оптимального решения по защите ваших прав." href="/uslugi/dlya-grazhdan/zashhita-prav-potrebitelej.html"><span itemprop="title">Защита прав потребителей</span></a></li>
				<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Покупка некачественного товара" href="/uslugi/dlya-grazhdan/zashhita-prav-potrebitelej/pokupka-nekachestvennogo-tovara.html"><span itemprop="title">Покупка некачественного товара</span></a></li>
			</ul>
		</ul>
	</div>
	 <!--breadcrumbs-->
	<div class="service container">
		<div class="row">
			<div>
				<h1>Покупка некачественного товара</h1>
			</div>
			<div class="service-item">
				<div class="service-image col-xs-12 col-sm-5">
 <img src="/bitrix/images/pokupka-nekachestvennogo-tovara.jpg" alt="">
				</div>
				 <!--service-image-->
				<div class="service-info col-xs-12 col-sm-7">
					...
					<div class="new-sp">
						<ul>
							<li>
							Вам нужно обменять некачественный товар? </li>
							<li>
							Вам нужно, чтобы продавец устранил недостатки товара? </li>
							<li>
							Вам нужно вернуть товар и получить уплаченную сумму? </li>
							<li>
							Вам нужно вернуть технически сложный товар и получить уплаченную сумму? </li>
							<li>
							Вам нужно взыскать убытки, причиненные вследствие продажи товара ненадлежащего качества? </li>
						</ul>
						 <!--service-list-->
					</div>
 <button class="btn btn-black" data-toggle="modal" data-target="#consultModal">ПРОКОНСУЛЬТИРОВАТЬСЯ</button>
	...
	<div class="service-text-block">
		<div class="container">
			...
			Покупка некачественного товара, <span>важно знать! </span> </h2>
			<p>
				Довольно часто можно видеть в&nbsp;магазине объявление о&nbsp;том, что товар обмену и&nbsp;возврату не&nbsp;подлежит. Однако следует знать, что продавец самостоятельно не&nbsp;может регулировать данный вопрос&nbsp;— он&nbsp;обязан действовать в&nbsp;строгом соответствии с&nbsp;законодательством о&nbsp;защите прав потребителей, которым, в&nbsp;свою очередь, четко регламентировано, какие товары можно возвращать и&nbsp;обменивать и&nbsp;в&nbsp;каких случаях.
			</p>
			<p>
				Также распространенной является ситуация, когда продавцы незаконно не&nbsp;принимают товар с&nbsp;очевидными для потребителя недостатками, упорно их&nbsp;не&nbsp;замечая.
			</p>
			<p>
				Если считаете, что Ваши права потребителя были нарушены&nbsp;— обратитесь в&nbsp;ЦПУ «Имею Право», где Вас проконсультируют по&nbsp;сложившейся ситуации и&nbsp;в&nbsp;случае, если нарушение действительно имело место быть&nbsp;— помогут в&nbsp;восстановлении и&nbsp;защите прав.
			</p>
		</div>
		 <!--container-->
	</div>
		...
		<div class="container">
			...
			<div class="consult-box row">
				...
				<div class="consult-form col-xs-12 col-md-6">
					...
					<form action="/uslugi/dlya-grazhdan/zashhita-prav-potrebitelej/pokupka-nekachestvennogo-tovara.html#form_consult" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
 ...
 <button type="button" class="btn btn-white" data-toggle="modal" data-target="#consultModal">
	...
	<div class="container">
		<div class="practice-block">
			...
			<div class="row" style="position: relative; height: 747px;">
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 0px; top: 0px;">
					...
					<ul class="case-list">
						...
						<div class="case-item-text">
							<p>
								Купленные туфли оказались некачественными — стиралась и отклеивалась подошва
							</p>
						</div>
 </li>
						...
						<div class="case-item-text">
							<p>
								В ходе процесса Ответчик добровольно вернул деньги, уплаченные за туфли — 6000 рублей. Кроме того, суд своим решением взыскал неустойку 1300 руб., моральный вред 1000 руб., штраф 500 руб., расходы на оформление доверенности и оплату услуг представителя. Решение было исполнено за 3 дня.
							</p>
						</div>
 </li>
					</ul>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 485px; top: 0px;">
					...
					<ul class="case-list">
						...
						<h4 class="case-item-name">Результат:</h4>
						<div class="case-item-text">
							Телефон заменен на новый в добровольном порядке
						</div>
 </li>
					</ul>
				</div>
				 <!--case-box-->
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 460px;">
					<div class="case-label">
						Дело №03060
					</div>
					...
					<ul class="case-list">
						...
						<h4 class="case-item-name">Результат:</h4>
						<div class="case-item-text">
							Недостатки устранены, продавец компенсировал добровольно 30 000 рублей
						</div>
 </li>
					</ul>
				</div>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 460px;">
					...
					<ul class="case-list">
						...
						<h4 class="case-item-name">Результат:</h4>
						<div class="case-item-text">
							Удовлетворение требований Клиента продавцом добровольно в десятидневный срок
						</div>
 </li>
					</ul>
				</div>
			...
			<div class="pavel-box">
				<div class="row">
					<div class="pavel-image col-xs-12 col-sm-4">
						<img src="/images/d-pravo-kontakt-f.jpg" alt="Павел">
					</div>
 ...
 <img src="/bitrix/images/anon-quote2.png" class="opinion-image" alt="Фото">
				<div class="opinion-info">
					<h3 class="opinion-name">Елена</h3>
					<p class="opinion-text">
						Особенно хочется отметить человеческое отношение специалистов к клиенту, общение во время сотрудничества был приятным
					</p>
					 <!--<a href="/images/otziv/elena-otziv.jpg">Смотреть оригинал</a>--> <a href="/images/otziv/elena-otziv.jpg" class="to-original" data-lightbox="image-1">Смотреть оригинал</a>
				</div>
			</div>
