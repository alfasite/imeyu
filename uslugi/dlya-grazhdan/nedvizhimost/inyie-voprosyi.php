...
$APPLICATION->SetPageProperty("title", "Иные вопросы по недвижимости для граждан");
$APPLICATION->SetPageProperty("description", "✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» Оказывает юридические услуги и правовую помощь в Орле по различным вопросам недвижимости для граждан, проводит юридические консультации и услуги представителя в суде ➡ Узнать подробнее ✔");
...
?><div class="page-content">
	<div class="breadcrumbs container">
		<ul>
			<ul class="B_crumbBox">
				...
				<li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_crumb" itemprop="url" rel="✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» в Орле окажет юридическую помощь специалистов по оформлению недвижимости, спорами с застройщиками ➡ Узнать подробнее ✔" href="/uslugi/dlya-grazhdan/nedvizhimost.html"><span itemprop="title">Недвижимость</span></a></li>
				<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» Оказывает юридические услуги и правовую помощь в Орле по различным вопросам недвижимости для граждан, проводит юридические консультации и услуги представителя в суде ➡ Узнать подробнее ✔" href="/uslugi/dlya-grazhdan/nedvizhimost/inyie-voprosyi.html"><span itemprop="title">Иные вопросы</span></a></li>
			</ul>
		</ul>
	</div>
	 <!--breadcrumbs-->
 ...
 <img src="/bitrix/images/in-sp-semeinoe-zemlya-i-ned.jpg" alt="">
				</div>
				 <!--service-image-->
				<div class="service-info col-xs-12 col-sm-7">
					...
					<div class="new-sp">
						<ul>
							<li>Вам нужно признать право на получение квартиры?</li>
							<li>Вам нужно взыскать компенсацию за пользование большей площадью квартиры?</li>
							<li>Вам нужно взыскать арендную плату или защитить себя от неправомерного взыскания?</li>
							<li>Вам нужно признать право собственности в порядке наследования?</li>
						</ul>
						 <!--service-list-->
					</div>
 <button class="btn btn-black" data-toggle="modal" data-target="#consultModal">ПРОКОНСУЛЬТИРОВАТЬСЯ</button>
	...
	<div class="service-text-block">
		<div class="container">
			...
			<p>
				 В ЦПУ «Имею Право» Вы можете получить юридическую помощь квалифицированных специалистов по оформлению недвижимости, земельным, кадастровым спорам, спорам с застройщиками: консультирование, составление и анализ различного рода документов и исков, представление интересов в суде и иные возможные механизмы защиты и реализации Ваших прав.
			</p>
			<p>
 ...
 <span>Заполните форму,</span> и мы свяжемся с Вами
					...
					<form action="/uslugi/dlya-grazhdan/nedvizhimost/inyie-voprosyi.html#form_consult" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
 ...
 <span>3</span>
	...
	<div class="container">
		<div class="practice-block">
			...
			<div class="row" style="position: relative; height: 851px;">
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 0px; top: 0px;">
					...
					<ul class="case-list">
						...
						<div class="case-item-text">
							<p>
 <span>Истцы получили проживали в квартире, полученной по ордеру, выплатили павевой взнос в кооператив, но кооператив был ликвидирован.</span>
							</p>
						</div>
 </li>
						...
						<div class="case-item-text">
							<p>
 <a href="/files/Решения/5059 (2).PDF">Решение суда</a>
							</p>
						</div>
 </li>
						...
						<div class="case-item-text">
							<p>
 <span>Судом было признано право собственности за Истцами на квартиру</span>
							</p>
						</div>
 </li>
					</ul>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 485px; top: 0px;">
					...
					<ul class="case-list">
						...
						<p class="case-item-hidden">
							 Клиенту, наследнику второй очереди, было завещано недвижимое имущество. Наследники первой очереди получили наследство по закону, претендовали на получение доли завещанного Клиенту наследства.
						</p>
 <a href="#" class="case-item-more">Подробнее</a> </li>
						...
						<h4 class="case-item-name">Результат:</h4>
						<div class="case-item-text">
							 Судом было признано право собственности Клиента на имущество
						</div>
 </li>
					</ul>
				</div>
				 <!--case-box-->
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 552px;">
					<div class="case-label">
						 Дело №02025
					</div>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 552px;">
					...
					<ul class="case-list">
						...
						<div class="case-item-text">
							<p>
								 Суд обязал администрацию совершить действия по предоставлению квартиры
							</p>
						</div>
 </li>
					</ul>
