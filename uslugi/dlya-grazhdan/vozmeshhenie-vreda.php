...
$APPLICATION->SetPageProperty("title", "Возмещение вреда — ЦПУ «ИМЕЮ ПРАВО»");
$APPLICATION->SetPageProperty("description", "✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» в Орле, поможет по вопросам возмещения материального и морального вреда, вреда, причиненного жизни и здоровью ➡ Узнать подробнее ✔");
...
?><div class="page-content">
	<div class="breadcrumbs container">
		<ul>
			<ul class="B_crumbBox">
				...
				<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="✔ Центр Правовых Услуг ★★★★★ «ИМЕЮ ПРАВО» в Орле, поможет по вопросам возмещения материального и морального вреда, вреда, причиненного жизни и здоровью ➡ Узнать подробнее ✔" href="/uslugi/dlya-grazhdan/vozmeshhenie-vreda.html"><span itemprop="title">Возмещение вреда</span></a></li>
			</ul>
		</ul>
	</div>
	 <!--breadcrumbs-->
	<div class="catalog-block container">
		...
		<div class="row">
 <a href="/uslugi/dlya-grazhdan/vozmeshhenie-vreda/vred-prichinennyij-zhizni-i-zdorovyu.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/vozmestit-me-2.jpg" alt="" class="catalog-box-image" style="width: 105px; height: 104px; top: 30px; left: 52px;">
			</div>
			<h3 class="catalog-box-name"><span>Вред, причиненный жизни и здоровью</span></h3>
 </a> <!--catalog-box--> <a href="/uslugi/dlya-grazhdan/vozmeshhenie-vreda/imushhestvennyij-vred.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/vozmestit-me-3.jpg" alt="" class="catalog-box-image">
			</div>
			<h3 class="catalog-box-name"><span>Имущественный вред</span></h3>
 </a> <!--catalog-box--> <a href="/uslugi/dlya-grazhdan/vozmeshhenie-vreda/moralnyij-vred.html" class="catalog-box col-xs-12 col-sm-6 col-md-3">
			<div class="catalog-box-inner">
 <img src="/bitrix/images/vozmestit-me-1.jpg" alt="" class="catalog-box-image">
			</div>
			<h3 class="catalog-box-name"><span>Возмещение морального вреда</span></h3>
 </a> <!--catalog-box-->
		</div>
		 <!--row-->
	</div>
		...
		<div class="container">
			...
			<div class="consult-box row">
				...
				<div class="consult-form col-xs-12 col-md-6">
					...
					<form action="/uslugi/dlya-grazhdan/vozmeshhenie-vreda.html#form_lawyer" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
 ...
 <input class="btn btn-red" type="submit" name="btn_lawyer" value="ПОЛУЧИТЬ КОНСУЛЬТАЦИЮ">
	...
	<div class="catalog-block container">
		<p>
			В&nbsp;ЦПУ «Имею Право» Вы&nbsp;можете получить юридическую помощь квалифицированных специалистов по&nbsp;вопросам возмещения материального и&nbsp;морального вреда, вреда, причиненного жизни и&nbsp;здоровью: консультирование, составление и&nbsp;анализ различного рода документов и&nbsp;исков, представление интересов в&nbsp;суде и&nbsp;иные возможные механизмы защиты и&nbsp;реализации Ваших прав.
		</p>
		<p>
