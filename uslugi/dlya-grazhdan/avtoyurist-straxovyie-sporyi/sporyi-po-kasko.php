...
$APPLICATION->SetPageProperty("title", "Юрист по КАСКО, юридическая консультация и помощь адвоката по КАСКО");
$APPLICATION->SetPageProperty("description", "Юридическая помощь в вопросах по КАСКО при ДТП. Бесплатная консультация автоюриста по телефону 8 (4862) 784-784. Звоните! В ЦПУ «Имею Право» Вам помогут решить все возникшие вопросы.");
...
?><div class="page-content">
	<div class="breadcrumbs container">
		<ul>
			<ul class="B_crumbBox">
				...
				<li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_crumb" itemprop="url" rel="Юридическая помощь в спорах со страховыми компаниями по осаго и ДТП. Бесплатная консультация по телефону 8 (4862) 784-784. Звоните! В ЦПУ «Имею Право» Вам помогут решить все возникшие вопросы" href="/uslugi/dlya-grazhdan/avtoyurist-straxovyie-sporyi.html"><span itemprop="title">Автоюрист. Страховые споры</span></a></li>
				<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Юридическая помощь в вопросах по КАСКО при ДТП. Бесплатная консультация автоюриста по телефону 8 (4862) 784-784. Звоните! В ЦПУ «Имею Право» Вам помогут решить все возникшие вопросы." href="/uslugi/dlya-grazhdan/avtoyurist-straxovyie-sporyi/sporyi-po-kasko.html"><span itemprop="title">Юрист по КАСКО</span></a></li>
			</ul>
		</ul>
	</div>
	 <!--breadcrumbs-->
	<div class="service container">
		<div class="row">
			<div>
				<h1>Юрист по КАСКО</h1>
			</div>
			<div class="service-item">
				<div class="service-image col-xs-12 col-sm-5">
 <img src="/bitrix/images/spori-kasko.jpg" alt="">
				</div>
				 <!--service-image-->
				<div class="service-info col-xs-12 col-sm-7">
					...
					<div class="new-sp">
						<ul>
							<li>Вам нужно взыскать страховое возмещение?</li>
							<li>Вам нужно обязать направить автомобиль на ремонт?</li>
							<li>Вам нужно оспорить заниженный размер страховой выплаты?</li>
							<li>Вам нужно взыскать утрату товарной стоимости?</li>
							<li>Вам нужно получить страховое возмещение при полной гибели автомобиля?</li>
						</ul>
						 <!--service-list-->
					</div>
 <button class="btn btn-black" data-toggle="modal" data-target="#consultModal">ПРОКОНСУЛЬТИРОВАТЬСЯ</button>
	...
	<div class="service-text-block">
		<div class="container">
			<h2 class="service-text-block-heading">Юридические консультации КАСКО</h2>
			<p dir="ltr">
 <span>«Хорошо хоть есть страховка» — единственное положительное обстоятельство, которое можно найти при ДТП. Однако облегчение от наличия страхового полиса </span><span>КАСКО</span><span> часто проходит после обращения в страховую. Как правило, страховые компании очень часто находят в написанных ими же правилах страхования разные причины для отказа в выплате либо уверяют, что для ремонта будет достаточно выплаченной суммы. Избежать страховых споров </span><span>по КАСКО</span><span> в данном случае практически невозможно. Но при грамотном правовом сопровождении&nbsp;<span id="docs-internal-guid-b2ca18a2-7e4f-281f-0dfa-d0db490277c1"><span>страховых юристов КАСКО,</span></span> шанс выиграть подобного рода спор стремится к ста процентам.</span>
			</p>
			<p>
 <span id="docs-internal-guid-f0e54ecf-89ad-6002-7267-a35ccc6ba3b5"><span>Обратившись к </span><span>юристам по с КАСКО</span><span> в ЦПУ «Имею право», Вы избежите риска допустить процессуальные ошибки, имеющие порой решающее значение, а также сможете восстановить свои права в полном объеме.</span></span>
			</p>
		</div>
		 <!--container-->
	</div>
 ...
 <span>Заполните форму,</span> и мы свяжемся с Вами
					...
					<form action="/uslugi/dlya-grazhdan/avtoyurist-straxovyie-sporyi/sporyi-po-kasko.html#form_consult" method="POST" onsubmit="$('#sid_feedback').attr('value', '')">
 ...
 <span>3</span>
	...
	<div class="container">
		<div class="practice-block">
			...
			<div class="row" style="position: relative; height: 1088px;">
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 0px; top: 0px;">
					...
					<ul class="case-list">
						...
						<div class="case-item-text">
							<p>
								 Страховая компания не выплатила страховое возмещение в полном объеме, ссылаясь на согласие Страхователя с условиями правил страхования, в соответствии с которыми предусмотрено осуществление выплаты с установленным Страховщиком коэффициентом индексации
							</p>
						</div>
 </li>
						...
						<div class="case-item-text">
							<p>
 <a href="/files/Решения/5043.pdf">Решение</a>
							</p>
						</div>
 </li>
						...
						<div class="case-item-text">
							<p>
								 Положения правил страхования, нарушающие права Клиента, были признаны недействительными. Взысканы со страховой компании и получены: страховая выплата в размере 190 160 рублей, проценты за пользование чужими денежными средствами, компенсация морального вреда, штраф, расходы на услуги представителя
							</p>
						</div>
 </li>
					</ul>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: block; position: absolute; left: 485px; top: 0px;">
					...
					<ul class="case-list">
						...
						<div class="case-item-text">
							<p>
								 Страховая не доплатила 57 238 рублей 46 копеек за ремонт автомобиля
							</p>
						</div>
 </li>
						<li class="case-item case-work">
						...
						<div class="case-item-text">
							<p>
								 Взыскана недоплата и 43 513,57 рублей — неустойка, штраф, моральный вред, 3000 — стоимость оценки, 12 000 — оплата услуг юриста. Исполнено в течение 13 дней
							</p>
						</div>
 </li>
					</ul>
				 ...
				 <!--case-box-->
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 676px;">
					<div class="case-label">
						 Дело №02037
					</div>
					<h3 class="case-heading">Взыскание недоплаты</h3>
					<ul class="case-list">
						...
						<div class="case-item-text">
							<p>
								 Страховая не доплатила 207 872 рубля за ремонт
							</p>
						</div>
 </li>
						<li class="case-item case-work">
						...
						<div class="case-item-text">
							<p>
								 Взыскана недоплата, штраф 50 000 рублей, неустойки и моральный вред — не менее 10 000 рублей, оплата услуг юриста — 10 000 рублей
							</p>
						</div>
 </li>
					</ul>
				...
				<div class="case-box col-xs-12 col-lg-6" style="display: none; position: absolute; left: 485px; top: 676px;">
					...
					<ul class="case-list">
						...
						<div class="case-item-text">
							<p>
								 Страховая не доплатила 18406 рублей 50 копеек за ремонт.
							</p>
						</div>
 </li>
						<li class="case-item case-work">
						...
						<div class="case-item-text">
							<p>
								 Взыскана недоплата и 44 312,50 рублей — неустойка, штраф, моральный вред, 2500 — стоимость оценки, 10 000 — оплата услуг юриста. Исполнено в течение 17 дней
							</p>
						</div>
 </li>
					</ul>
