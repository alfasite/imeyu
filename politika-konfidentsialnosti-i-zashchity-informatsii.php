...
$APPLICATION->SetPageProperty("description", "Политика конфиденциальности и защиты информации");
$APPLICATION->SetTitle("Политика конфиденциальности и защиты информации");
?><div class="catalog-block container">
	<div>
		<h1>Политика конфиденциальности и защиты информации</h1>
	</div>
	<p>
		 Настоящее Положение о политике конфиденциальности и защиты информации (далее — Политика) определяет порядок обработки и защиты информации о физических лицах, пользующихся сервисами, информацией, услугами, программами и продуктами Компании, в том числе всей информации, которую сайт имею-право.рф (далее Сайт) может получить о пользователе во время его использования.
	</p>
	<p>
	...
	<h2 class="catalog-block-heading general-heading">Получение персональной информации</h2>
	<p>
	...
	<h2 class="catalog-block-heading general-heading">Идентификационные файлы (cookies) и иные технологии</h2>
	<p>
	...
	<h2 class="catalog-block-heading general-heading">Условия обработки персональной информации пользователя и её передачи третьим лицам</h2>
	<p>
	...
	<h2 class="catalog-block-heading general-heading">Безопасность</h2>
	<p>
	...
	<h2 class="catalog-block-heading general-heading">Изменение Политики конфиденциальности. Применимое законодательство</h2>
	<p>
